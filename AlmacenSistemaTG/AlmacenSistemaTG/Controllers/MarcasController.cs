...
namespace AlmacenSistemaTG.Controllers
{
    public class MarcasController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "IdMarca,Descripcion,Clave")] Marca marca)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "IdMarca,Descripcion,Clave")] Marca marca)
        {
            if (ModelState.IsValid)
            {
